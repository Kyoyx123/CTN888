            ...
            <form action="allbutton.php" method="post">
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    ...
                    <tr>
                        ...
                        <td><a href="status.php?id=<?php echo $row['id']?>&status=0" class="status1" name="status0" type="submit">เปิด</a></td>
                        <?php } else { ?>
                        <td><a href="status.php?id=<?php echo $row['id']?>&status=1" class="status0" name="status1" type="submit">ปิด</a></td>
                        <?php } ?>
                        <input type="hidden" value="<?php echo $row['id']?>" name="id">
                        

                        <td><a href="allbutton.php?choice=<?php echo $row['choice'] ?>&id=<?php echo $row['id'] ?>" name="add" class="add">เพิ่ม</a></td>
                        <td><a href="./editquiz/editquestion.php?id=<?php echo $row['id']?>" name="edit" class="edit">แก้ไข</a></td>
                        <td><button type="submit" name="delete" class="remove" onclick="return confirm('คุณต้องการลบหรือไม่!?')">ลบ</button></td>
                    </tr>
                <?php } ?>
            </form>
        </table>
